...
// 1 à l'allée, 0 au retour
//#include <SoftwareSerial.h>
 //HardwareSerial Serial2(15);
...
void setup() {
   ...
   ledcSetup(14, 50, 16); // canal, fréquence, résolution
   //ledcAttachPin(broche_servo, 14); // broche, canal
   s1.attach(14);
...
void loop() {
  ...
  ////////////////////////
  s1.write(90); // faire tourner le servo à 90 degrés
  delay(5000); // attendre 5 secondes
  s1.write(0); // ramener le servo à 0 degrés
  delay(5000);
  ////////////////////////
